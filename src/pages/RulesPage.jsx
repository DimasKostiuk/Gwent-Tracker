        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-2">
            ...
            <p className="text-[17px] leading-relaxed text-stone-400">
              ...
              одна одну, і фіксується справжня нічия. Виняток: якщо обидва перші раунди
              завершились нічиєю (рахунок 0:0), третій раунд не грається — партія одразу
              фіксується як нічия, бо жоден із гравців ще не має перемоги в раунді.
            </p>
          </section>
